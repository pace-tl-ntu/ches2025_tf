...
def evaluate(model, X_attack, plt_attack,correct_key,leakage_fn, nb_attacks=100, total_nb_traces_attacks=2000, nb_traces_attacks = 1700):
    predictions = model.predict(X_attack[:total_nb_traces_attacks])
